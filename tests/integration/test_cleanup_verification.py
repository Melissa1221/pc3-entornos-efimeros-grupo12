...
class TestCleanupOperations:
    ...
    def test_cleanup_orphaned_resources(self):
        ...
        with patch('subprocess.run') as mock_run:
            with patch.object(CleanupVerifier, 'get_orphaned_containers', return_value=['container1']):
                with patch.object(CleanupVerifier, 'get_orphaned_volumes', return_value=['volume1']):
                    mock_run.return_value.returncode = 0
...
class TestCleanupIntegration:
    ...
    def test_cleanup_with_orphaned_resources(self):
        ...
        with patch.object(CleanupVerifier, 'get_orphaned_containers', return_value=['orphan-container']):
            with patch.object(CleanupVerifier, 'get_orphaned_volumes', return_value=['orphan-volume']):
                with patch('subprocess.run') as mock_run:
                    mock_run.return_value.returncode = 0
